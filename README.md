...
extraction, and loop) lives in the Spanish README under [«Por qué XML»](README.es.md#por-qué-xml).
...
Full annotated examples (HTTP + headers, full pipeline with pagination, CSV+web unified): see
[`README.es.md`](README.es.md) — same XML syntax, comments in Spanish.
...
| Document | Contents |
|----------|----------|
| [`README.es.md`](README.es.md) | Full README in Spanish (detailed examples, extended sections) |
