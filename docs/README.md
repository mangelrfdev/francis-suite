...
| Guía | Tema |
|------|------|
| [record-save.md](guides/record-save.md) | `<record-save>` — formatos, `record-journal`, `record-export-*`, `show-attribute`, `record-xml-*`, ejemplos `books_all_pages.xml` / `all_books_pages.xml` |
