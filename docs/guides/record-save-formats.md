...
**Implementación actual (incl. xml, html, txt, excel, parquet), ejemplos, `record-export-*` y tabla “cuándo usar cada formato”:** [record-save.md](record-save.md) (incluye `examples/books_all_pages.xml`).
